...
export default function ScrollText() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-obsidian py-20 lg:py-0 lg:h-[300vh]">
      <div className="lg:sticky lg:top-0 lg:h-screen flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-0 px-6 overflow-hidden">
        {/* Left Words */}
        <div className="flex-1 flex flex-col items-center lg:items-end lg:pr-8 z-10" style={{ perspective: 1000 }}>
          {leftWords.map((word, i) => (
            <h2
              ...
              className="font-display font-bold text-5xl sm:text-7xl md:text-8xl lg:text-[10vw] text-white uppercase leading-[0.85] mb-[8vh] lg:mb-[12vh] text-center lg:text-right"
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start lg:pl-8 z-10" style={{ perspective: 1000 }}>
          {rightWords.map((word, i) => (
            <h2
              ...
              className="font-display font-bold text-5xl sm:text-7xl md:text-8xl lg:text-[10vw] text-white uppercase leading-[0.85] mb-[8vh] lg:mb-[12vh] text-center lg:text-left"
              style={{ transformStyle: 'preserve-3d' }}
            >
              {word}
            </h2>
